...
public class TC_0401 extends BaseDriver {
    ...
    @Test
    public void SuccessfulPaymentCheck() {
...
//        wait.until(ExpectedConditions.elementToBeClickable(tce04.payButton));
//
...
//
//        System.out.println("Order No : " + tce04.orderNumber.getText());

        // TODO: Failed frame transition to pay button , to be checked
